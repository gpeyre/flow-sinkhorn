...
abbrev lem_A_1 := @perStepAscent_residualProxy_of_massShellVariationalMathlibPinsker_klGains_commonMass -- impl: DualConvergence/PerStepAscent.lean
abbrev lem_A_2 := @dualGap_le_twoUmax_of_pairingBound_quotientSup_lt_Umax -- impl: DualConvergence/GapResidual.lean
abbrev prop_A_1 := @normalizedPinsker_of_finite_variational_mathlib_hoeffding -- impl: DualConvergence/Pinsker.lean
abbrev lem_A_3 := @pinsker_nonnormalized_of_massShell_variational_mathlib_hoeffding -- impl: DualConvergence/Pinsker.lean
...
abbrev prop_5_2 := @graphW1_flowSinkhorn_update_as_stated -- impl: Applications/GraphW1/ClosedForms.lean
...
abbrev lem_per_step_ascent := @perStepAscent_residualProxy_of_massShellVariationalMathlibPinsker_klGains_commonMass -- impl: DualConvergence/PerStepAscent.lean
...
abbrev prop_pinsker_normalized := @normalizedPinsker_of_finite_variational_mathlib_hoeffding -- impl: DualConvergence/Pinsker.lean
abbrev lem_pinsker_nonnormalized := @pinsker_nonnormalized_of_massShell_variational_mathlib_hoeffding -- impl: DualConvergence/Pinsker.lean
...
abbrev prop_graphw1_flow_sinkhorn_update := @graphW1_flowSinkhorn_update_as_stated -- impl: Applications/GraphW1/ClosedForms.lean
